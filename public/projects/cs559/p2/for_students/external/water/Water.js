...
// This code is from THREE.js examples, and is used to create water using both a reflector and a refractor.
// For more details, see external/README.txt
...
class Water extends Mesh {
    ...
    constructor( geometry, options = {} ) {
        ...
        const normalMap0 = options.normalMap0 || textureLoader.load( './external/water/Water_1_M_Normal.jpg' );
        const normalMap1 = options.normalMap1 || textureLoader.load( './external/water/Water_2_M_Normal.jpg' );
